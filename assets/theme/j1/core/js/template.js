...
(function (root, factory) {
  ...
  // Default options.
  var defaultOptions = __webpack_require__(6873);
  // Object to store current options.
  var options = {};
  // Object for public APIs.
  var tocbot = {};
  var BuildHtml = __webpack_require__(3237);
  var ParseContent = __webpack_require__(1500);
  var updateTocScroll = __webpack_require__(1395);
  ...
  tocbot.init = function (customOptions) {
    ...
    if (options.scrollSmooth) {
      ...
      tocbot.scrollSmooth = (__webpack_require__(3302).initSmoothScrolling)(options);
    }
...
// -----------------------------------------------------------------------------
module.exports = function (options) {
  const defaultOptions = __webpack_require__(2156);
  const ParseContent = __webpack_require__(5753);
...
module.exports = function scrollSmooth(options) {
  ...
  return {
    ...
    scroll: function (target, options) {
      var logger;
      var logText;
      logger = log4javascript.getLogger('j1.api.scrollSmooth');
...
/* global window                                                              */
(function ($) {
  const defaultOptions = __webpack_require__(1724);
  const ParseContent = __webpack_require__(1641);
  const parseContent = ParseContent(defaultOptions);
...
window.j1.api = __webpack_require__(4754);
window.j1.api.anime = __webpack_require__(9193); // added for fab
window.j1.api.asciidoctor = __webpack_require__(5893);
window.j1.api.consoleFilters = __webpack_require__(9959);
window.j1.api.errorFilters = __webpack_require__(9261);
window.j1.api.navigator = __webpack_require__(7573);
window.j1.api.scrollSmooth = __webpack_require__(7893);
...
const J1Tocbot = __webpack_require__(2988);
const J1AttrChangeListener = __webpack_require__(7376);
const J1SCarousel = __webpack_require__(2918);
const J1Speak2Me = __webpack_require__(9894);

// Additional Vanilla JS helpers
// -----------------------------------------------------------------------------
const J1AdocResultViewer = __webpack_require__(1817);
